        ...
        <Container sx={{ py: 8 }}>
          <Grid container spacing={6} alignItems="center">
            ...
            <Grid item xs={12} md={6}>
              ...
              <Typography color="text.secondary" lineHeight={2} mt={2}>
        ...
        <Box sx={{ bgcolor: "white", py: 8 }}>
          <Container>
            ...
            <Grid container spacing={3}>
              ...
              {[
                { title: "Best Prices",     desc: "Affordable fashion for everyone." },
                { title: "Premium Quality", desc: "Comfortable and durable fabrics." },
